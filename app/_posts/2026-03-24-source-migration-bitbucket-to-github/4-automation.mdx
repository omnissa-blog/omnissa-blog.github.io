...
[← Back to overview](/story/2026-03-24-source-migration-bitbucket-to-github)
...
With prep and tools in place, the migration platform could run. Manual migration was never an option at our scale. This automation spans all three phases—pre-migration analysis ([Pre-Migration Steps](/story/2026-03-24-source-migration-bitbucket-to-github/1-pre-migration)), migration execution ([Migration](/story/2026-03-24-source-migration-bitbucket-to-github/2-migration)), and post-migration setup ([Post-Migration](/story/2026-03-24-source-migration-bitbucket-to-github/3-post-migration)). The platform was built in two layers:
...
For bbs2gh requirements and the manual `gh bbs2gh migrate-repo` invocation, see [Migration](/story/2026-03-24-source-migration-bitbucket-to-github/2-migration).
...
---
### Next: [Back to overview](/story/2026-03-24-source-migration-bitbucket-to-github)
