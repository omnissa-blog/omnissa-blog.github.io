...
Before running migration, ensure [Pre-Migration Steps](/story/2026-03-24-source-migration-bitbucket-to-github/1-pre-migration) are complete—analysis, cleanup, rules extraction, and the per-repository readiness checklist.
...
Our `github-migration-tools` Docker image packages all of this—bbs2gh, GitHub CLI, SSH config, and AWS/Azure CLI—for deterministic runs. For our migration runner architecture and how we orchestrated it at scale, see [Our Automation](/story/2026-03-24-source-migration-bitbucket-to-github/4-automation).
...
Review the migration log for success or failure. In our setup, the automation invoked this inside the container—no manual run. See [Our Automation](/story/2026-03-24-source-migration-bitbucket-to-github/4-automation).
...
---
Next: [Post-Migration](/story/2026-03-24-source-migration-bitbucket-to-github/3-post-migration)