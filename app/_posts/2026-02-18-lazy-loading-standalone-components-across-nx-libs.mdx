...
- **Test signal resolution:** Use `await vi.waitFor(() => componentTypeSig() !== null)` to wait for the promise to resolve, then verify the signal contains the expected component type.
